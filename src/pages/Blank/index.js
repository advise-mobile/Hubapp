...
export default class ExpandableCalendarScreen extends Component {
  ...
  renderItem = ({ item }) => {
    ...
    return (
      <TouchableOpacity onPress={() => this.itemPressed(item.title)} style={styles.item} testID={'item'}>
        <View>
  ...
  render() {
    return (
      ...
      >
        {this.props.weekView ? (
          <WeekCalendar testID={'weekCalendar'} firstDay={1} markedDates={this.getMarkedDates()} />
        ) : (
          <ExpandableCalendar
