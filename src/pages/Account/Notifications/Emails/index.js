...
export default Emails = props => {
  ...
  const activeOptions = useRef(new Animated.Value(1)).current;
  ...
  const handleNewPublications = () => {
    ...
    const value = activeOptions.__getValue() == 0 ? 1 : 0;
          ...
          >
            ...
            <ListItem>
              ...
              <ListContent as={Animated.View} style={{
                overflow: 'hidden',
                flex: 1,
                maxHeight: activeOptions.interpolate({
                  inputRange: [0, 1],
                  outputRange: [0, 500],
                })
              }}>
