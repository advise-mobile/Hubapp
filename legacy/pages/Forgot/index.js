...
const Forgot = props => {
  ...
  const sendedIcon =
    colorUseTheme.name == 'dark'
      ? require('assets/images/icons/email_white.png')
    ...
    <Container>
      {!sended ? (
        <Content>
          ...
          <Description>
            Informe seu email de cadastro para receber informações de como
          ...
          <Form>
            ...
            <Button onPress={handleForgotPress} disabled={disabled}>
              {loading ? (
                ...
                <ButtonText>Enviar informações</ButtonText>
              )}
            </Button>
        ...
        <Content>
          ...
          <Description>
            Assim que abrir o email, clique em redefinir senha para criar uma
            nova senha.
          </Description>
          <LogintLink onPress={backToLogin}>
            <LoginLinkText>Voltar para acessar conta</LoginLinkText>
