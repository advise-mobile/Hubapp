...
import Api, { BASE_URL, getLogin } from '@lservices/Api';
    ...
    <Movement>
      <MovementTags>
        {movement.dataDivulgacaoFormatada && (
          <Tag background={colors.gray}>
            <TagText>
              Disponibilização em: {movement.dataDivulgacaoFormatada}
            </TagText>
          </Tag>
        )}
        ...
        {movement.paginaInicial > 0 && movement.paginaFinal > 0 && (
          <Tag background={colors.gray}>
            <TagText>
              Páginas: {movement.paginaInicial || 0} a{' '}
              {movement.paginaFinal || 0}
            </TagText>
          </Tag>
        )}
      </MovementTags>
